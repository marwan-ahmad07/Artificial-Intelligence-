...
def benchmark():
    ...
    for diff in difficulties:
        ...
        # Run multiple trials so the average time is less sensitive to noise.
        ac3_times = []
        mac_times = []
        backtrack_times = []
        ac3_success_count = 0
        ...
        for _ in range(5):
            ...
            # 1. Pure AC-3: inference only, no guessing.
            ...
            # 2. MAC: combine propagation with search.
            ...
            # 3. Pure Backtracking: DFS search with constraint checks only.
